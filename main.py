...
def start():
    ...
    if loop == "":
        ...
        if loop.lower() == "inf":
            loop = 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        else:
            try:
                loop = int(loop)
            except:
        ...
        while loop:
            driver = webdriver.Chrome(executable_path='C:\\Users\\mak_4\\Downloads\\YoutubeBot-main\\YoutubeBot-main\\Chrome\\chromedriver.exe')
